...
Obviously, the EFI excludes my Serial Number, MLB, SmUUID & ROM - you must add your own before using the EFI.
...
Turbo Boost Unlock for dual E5-2678v3 Xeon.  My EFI includes extra driver V3.efi to support turbo boost unlock on all cores (3.3Ghz on all cores).  You must use modified bios with microcode removed AND under Kernel -> Quirks you must set AppleXcpmForceBoost to "True".
