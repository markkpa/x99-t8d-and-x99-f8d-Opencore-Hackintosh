...
I have a multiboot system including macos Big Sur, Windows 10, Ubuntu.  I am NOT using opencore as a bootloader for Windows 10, PopOS and Qubes.   Windows 10, PopOS & Qubes are much more stable being booted directly to the original bios rather than through opencore (press F7 for bootloader).
