...
Now includes AppleALC for REALTEK ALC887 (I no longer use VoodooHDA).  Also, power management much improved from before.  Includes a customized slide value in boot args.  And includes my USB mapping.
